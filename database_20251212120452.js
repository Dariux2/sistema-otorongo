...
function insertSampleData() {
    ...
    db.get('SELECT COUNT(*) as count FROM users', (err, row) => {
        ...
        if (row && row.count === 0) {
            ...
            // Estos son hashes de bcrypt para: admin123, medico123, recep123
            const users = [
            ...
            userStmt.finalize(checkComplete);
            ...
            patientStmt.finalize(checkComplete);
            ...
            historyStmt.finalize(checkComplete);
            ...
            appointmentStmt.finalize(checkComplete);
            ...
            invoiceStmt.finalize(checkComplete);
            ...
            serviceStmt.finalize(checkComplete);
        } else {
            dbReady = true;
        }
    });
